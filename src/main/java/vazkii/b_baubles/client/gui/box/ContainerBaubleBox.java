 ...
 */
package vazkii.b_baubles.client.gui.box;
...
import vazkii.b_baubles.client.gui.SlotLocked;
	...
	public ItemStack transferStackInSlot(EntityPlayer p_82846_1_, int p_82846_2_) {
		...
		if(slot != null && slot.getHasStack()) {
			...
			if(p_82846_2_ < 28) {
				...
				if(itemstack1 != null && (itemstack1.getItem() instanceof IBauble && !mergeItemStack(itemstack1, 4, 28, false)))
					return null;
			}
